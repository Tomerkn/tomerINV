...
if [[ -n $(git status --porcelain) ]]; then
    echo "יש שינויים שלא נדחפו ל-Git"
...
echo "   - DATABASE_URL (חובה)"
echo "   - OLLAMA_URL (אופציונלי)"
echo ""
...
echo "- האפליקציה תתחיל לעבוד תוך 2-5 דקות"
echo "- בדוק את הלוגים ב-Railway אם יש בעיות"
echo ""
